...
class HojaVida extends Component {
    ...
    crear = () => {
        ...
        console.log("hasta aqui si llego mijin")
    }
    ...
    AddHojas = (nuevaHoja) => {
        ...
        this.setState((estadoActual) => ({
                hojas: [...estadoActual.hojas, nuevaHoja]
            })
        );
        this.postData();
    };
        ...
        return (
            ...
            <div className="Perfil">
                ...
                <Row>
                    ...
                    <Col span={19}>
                        <Input style={{width: '31%'}} type="text"  onChange={(e) => this.handleChangeInput(e, 'numeroCedula')} name="numeroCedula" placeholder="17.....-X"/>
                    </Col>
                </Row>
                ...
                <Row>
                    ...
                    <Col span={19}>
                        ...
                        {/* <Input style={{width: '31%'}} type="text" value={nombre} onChange={this.handleFullNameChange} name="fullName" placeholder="Jhonathan"/> */}
                    </Col>
                </Row>
                ...
                <Row>
                    ...
                    <Col span={19}>
                        <Input.Group name="phone">
                            ...
                            <Input style={{width: '13%'}} type="text" onChange={(e) => this.handleChangeInput(e, 'telefono')} name="phone" placeholder="0990803132"/>
